...
type StallingInfo struct {
	...
	Parkingcapacity float32    `protobuf:"fixed32,2,opt,name=parkingcapacity,proto3" json:"parkingcapacity,omitempty"`
	Vacantspaces    float32    `protobuf:"fixed32,3,opt,name=vacantspaces,proto3" json:"vacantspaces,omitempty"`
...
func (x *StallingInfo) GetParkingcapacity() float32 {
	if x != nil {
...
func (x *StallingInfo) GetVacantspaces() float32 {
	if x != nil {
...
var file_stalling_stadskantoor_proto_rawDesc = []byte{
	...
	0x70, 0x61, 0x63, 0x69, 0x74, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0f, 0x70, 0x61,
	...
	0x01, 0x28, 0x02, 0x52, 0x0c, 0x76, 0x61, 0x63, 0x61, 0x6e, 0x74, 0x73, 0x70, 0x61, 0x63, 0x65,
